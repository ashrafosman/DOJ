...
export default {
  ...
  theme: {
    extend: {
      colors: {
        'doj-bg':        'rgb(var(--color-doj-bg) / <alpha-value>)',
        'doj-surface':   'rgb(var(--color-doj-surface) / <alpha-value>)',
        'doj-surface-2': 'rgb(var(--color-doj-surface-2) / <alpha-value>)',
        'doj-border':    'rgb(var(--color-doj-border) / <alpha-value>)',
        'doj-text':      'rgb(var(--color-doj-text) / <alpha-value>)',
        'doj-muted':     'rgb(var(--color-doj-muted) / <alpha-value>)',
        'doj-green':  '#22c55e',
        'doj-amber':  '#f59e0b',
        'doj-red':    '#ef4444',
        'doj-blue':   '#3b82f6',
